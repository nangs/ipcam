            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                if ((Boolean) newValue) {
                    new AlertDialog.Builder(SettingsActivity.this)
                            ...
                            .setMessage("Normally, IPCam only talks to local (LAN) IPs. Allowing all IPs to access IPCam poses a security risk because there is no built in authentication or encryption. Are you sure you want to proceed?")
